...
public class ResourceController : MonoBehaviour
{
...

    {
        ...
        {
            SfxManager.sfxInstance.Audio.PlayOneShot(SfxManager.sfxInstance.clickLocked);
            return;
        }
        ...
        _level++;
        SfxManager.sfxInstance.Audio.PlayOneShot(SfxManager.sfxInstance.clickUpgrade);
...

    {
        ...
        GameManager.Instance.ShowNextResource ();
         ...
         SfxManager.sfxInstance.Audio.PlayOneShot(SfxManager.sfxInstance.congrats);
